...
SET(APEX_DIR_SEARCH
  ${APEX_DIR_SEARCH}/framework/public
  ${DELTA3D_EXT_DIR}/inc
  /usr/include/APEX
...
FIND_PATH(APEX_FRAMEWORK_INCLUDES NxApex.h PATH_SUFFIXES ${VERSION_SUFFIX_FOR_PATH} PATHS
...
SET(APEX_FRAMEWORK_INCLUDE_DIR ${APEX_FRAMEWORK_INCLUDES})

IF (${CMAKE_SYSTEM} MATCHES "Linux")
    ADD_DEFINITIONS(-DLINUX -DNX_DISABLE_FLUIDS)
ENDIF (${CMAKE_SYSTEM} MATCHES "Linux")

set (APEX_FRAMEWORK_FOUND "NO")
if (APEX_FRAMEWORK_INCLUDE_DIR)
   set (APEX_FRAMEWORK_FOUND "YES")
endif (APEX_FRAMEWORK_INCLUDE_DIR)
